...
export default function TableMenu() {
  ...
  return (
    <div className="box-border min-h-dvh w-full max-w-full min-w-0 overflow-x-hidden bg-[radial-gradient(circle_at_top,_rgba(251,146,60,0.08),_transparent_28%),linear-gradient(180deg,#fffaf5_0%,#f8fafc_38%,#f8fafc_100%)] text-slate-900 pb-[env(safe-area-inset-bottom,0px)]">
      <header id="menu-top" className="sticky top-0 z-50 w-full max-w-full overflow-x-hidden border-b border-slate-200 bg-white/95 backdrop-blur-md pt-[env(safe-area-inset-top,0px)]">
        <div className={`mx-auto box-border flex w-full max-w-[min(72rem,100%)] min-w-0 items-center justify-between gap-3 px-4 transition-all duration-500 ease-in-out sm:px-5 lg:px-6 ${
          headerVisible ? "max-h-[200px] py-2.5 opacity-100" : "max-h-0 py-0 opacity-0 pointer-events-none -translate-y-10"
        }`}>
        ...
        <div
          ...
          className="mx-auto box-border flex min-h-[3.5rem] w-full max-w-[min(72rem,100%)] min-w-0 items-center px-4 pb-2 sm:px-5 lg:px-6"
        >
