...
export default function MenuBrowserRail({
  ...
  return (
    <div
      className="no-scrollbar box-border flex w-full max-w-full min-w-0 items-center justify-start gap-2.5 overflow-x-auto overscroll-x-contain pb-1 scroll-smooth sm:justify-center"
          ...
          >
            ...
            >
              <SafeMenuAsset
                ...
                fallback={<UtensilsCrossed className="h-4.5 w-4.5" />}
              />
            </span>
